...
export default function App() {
  ...
  return(
    <SafeAreaView style={styles.container}>
     {cpf == '' &&
      <>
      <Image source = {require('./components/boneco.png')}style={{width:100, height:100, alignItems:'center', marginTop:200, }}/>
      <TextInput
       style={styles.input}
       placeholder='CPF'
     ...
     {cpf == '000.000.000-00' &&
      <>
     <Image source = {require('./components/perfil.png')}style={{width:100, height:100, alignItems:'center', marginTop:200, }}/>
